...
QPointF
converter<dataflow::vec2<double>>::to_qml_type(const dataflow::vec2<double>& v)
{
  return QPointF(static_cast<qreal>(v.x()), static_cast<qreal>(v.y()));
}

dataflow::vec2<double>
converter<dataflow::vec2<double>>::from_qml_type(const QPointF& v)
{
  return dataflow::vec2<double>(static_cast<double>(v.x()),
                                static_cast<double>(v.y()));
}

QPointF
converter<dataflow::vec2<float>>::to_qml_type(const dataflow::vec2<float>& v)
{
  return QPointF(static_cast<qreal>(v.x()), static_cast<qreal>(v.y()));
}

dataflow::vec2<float>
converter<dataflow::vec2<float>>::from_qml_type(const QPointF& v)
{
  return dataflow::vec2<float>(static_cast<float>(v.x()),
                               static_cast<float>(v.y()));
}

QPointF
converter<dataflow::vec2<int>>::to_qml_type(const dataflow::vec2<int>& v)
{
  return QPointF(static_cast<qreal>(v.x()), static_cast<qreal>(v.y()));
}

dataflow::vec2<int>
converter<dataflow::vec2<int>>::from_qml_type(const QPointF& v)
{
  return dataflow::vec2<int>(static_cast<int>(v.x()), static_cast<int>(v.y()));
}
